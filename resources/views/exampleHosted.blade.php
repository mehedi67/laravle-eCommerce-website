    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1 m-auto">
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <input type="hidden" name="final_pay" value="{{ session('cart_form_subtotal')-session('cart_form_discount') }}">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">{{ session('cart_form_subtotal') }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0">Discount</h6>
                        </div>
                        <span class="text-muted">{{ session('cart_form_discount') }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between">
                        <h6>Total (BDT)</h6>
                        <strong>{{ session('cart_form_subtotal')-session('cart_form_discount') }} TK</strong>
                    </li>
                </ul>
